          ...
          >
            ...
            >
              ...
              <img
                ...
                alt=""
              />
               {songlink.length>0 && <i className={`absolute top-0 sm:h-[15vh] w-[10vw] h-full flex items-center justify-center text-5xl sm:w-[15vh]  opacity-80  duration-300 rounded-md ${
                      d.id === songlink[0]?.id ? "block" : "hidden"
