...
const MyPlaylists = () => {
  ...
  const { playlists, loadingPlaylists, createPlaylist, deletePlaylist, importPlaylist, fetchPlaylists } = usePlaylist();
        ...
        <div className="ml-auto flex items-center gap-3">
            <Tooltip text="Import songs from friends or backups" position="bottom">
                <button
                    ...
                    className="px-6 py-2 bg-slate-800 border border-white/10 rounded-full text-white font-black text-sm hover:bg-slate-700 hover:border-white/20 transition-all shadow-lg shadow-black/20 active:scale-95 flex items-center gap-2 sm:px-3"
                >
                    ...
                    {/* <i className="ri-import-line hidden sm:block text-xl"></i> */}
                </button>
            </Tooltip>
            <Tooltip text="Create New Playlist" position="bottom">
                <button
                    onClick={() => setShowCreate(true)}
                    className="px-6 py-2 bg-green-500 text-slate-900 rounded-full font-black text-sm hover:scale-105 transition-all shadow-lg shadow-green-500/10 active:scale-95 sm:px-4"
                >
            ...
            {playlists.map((pl, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg sm:text-sm font-black text-white tracking-tight truncate group-hover:text-green-400 transition-colors uppercase leading-none mb-1.5">{pl.name}</h3>
